        ...
        >
          ...
          <div className="relative glass rounded-3xl p-6 md:p-8 aspect-square flex items-center justify-center border border-accent/20 overflow-hidden shadow-xl shadow-accent/5">
            ...
            <div className="relative z-10 w-full h-full flex items-center justify-center">
              <div className="relative w-full h-full rounded-2xl bg-slate-800/60 dark:bg-slate-900/70 p-0 border border-white/10 shadow-2xl overflow-hidden">
                {/* Window title bar */}
                <div className="flex items-center justify-between px-3 py-2.5 border-b border-white/10 bg-slate-800/80 dark:bg-slate-900/80">
                ...
                {/* Code + line numbers */}
                <div className="flex font-mono text-xs sm:text-sm text-left">
                  <div className="select-none py-3 pl-3 pr-2 text-right text-slate-500 dark:text-slate-500 border-r border-white/5 bg-slate-900/30 dark:bg-slate-950/50">
                    {[1, 2, 3, 4, 5, 6, 7].map((n) => (
                  ...
                  <div className="flex-1 min-w-0 py-3 pl-3 pr-4 space-y-0.5">
                    <div className="text-accent/80 leading-[1.85]">
                      const developer = &#123;
                    </div>
                    ...
                    <div className="text-accent/80 leading-[1.85] inline-flex items-baseline">
                      &#125;;<span className="ml-0.5 inline-block w-0.5 h-4 bg-emerald-400 animate-cursor-blink align-middle" aria-hidden />
                    </div>
                  </div>
                </div>
                {/* Stack badge */}
                <div className="absolute bottom-2 right-2 px-2 py-0.5 rounded bg-slate-700/80 dark:bg-slate-800/80 border border-white/5 text-[10px] font-semibold text-slate-400 dark:text-slate-500">
                  TypeScript
                </div>
              </div>
            </div>
